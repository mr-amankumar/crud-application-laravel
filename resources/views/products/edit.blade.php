...
<body>
    <h3 style="color: blueviolet;padding-left:30px;"> Update Product</h3>
    <div class="container" style="Margin-top:30px">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <input type="text" name="qty" class="form-control" value="{{$product->qty}}" placeholder="qty">
            </div>
            <div class="col-sm-6">
            ...
            <button type="submit" class="btn btn-primary" style="margin-top:15px;margin-left:14px;">Update Product</button>
        </form>
    </div>
</body>
</html>